...
请注意，即使 Next.js 应用程序不生成 `.svelte-kit` 目录，反之亦然，也需要将 `.next/**` 和 `.svelte-kit/**` 都指定为 [`outputs`](/docs/reference/configuration#outputs)。
...
从那里，您可以定义标签可以拥有哪些依赖项或依赖者的规则。查看 [边界文档](/docs/reference/boundaries#tags) 了解更多详细信息。
